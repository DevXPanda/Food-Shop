...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-orange-700 via-orange-600 to-yellow-500 text-white py-14 rounded-t-3xl shadow-inner mt-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Ginni's Cafe</h3>
            <p className="text-gray-300 mb-4">
              Delicious food delivered to your doorstep. Fresh ingredients, amazing flavors, and fast delivery.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>Phone: +91 9696876253</li>
              <li>Email: Ginnicafe@gmail.com</li>
            </ul>
          </div>
        </div>
